...
public class AboutUs extends AppCompatActivity {
    ...
    String[] designaton = {"President, Student Association","Student Advisor, Student Association","Cultural Advisor","Student Advisor, Student Association","Student Advisor, Student Association","Cultural Secretary","Joint Cultural Secretary","Joint Cultural Secretary","Treasurer","Joint Treasurer","PG Coordinator","Vice President","General Secretary","Joint Secretary"};
